...
PipelineD::buildInnerQueryExecutorGeneric(Collection* collection,
    ...
    std::cout << "JJJ emptyA: " << pipeline->getSources().empty() << std::endl;
    BSONObj projForQuery = deps.toProjection();
    std::cout << "JJJ projForQuery: " << projForQuery << std::endl;
    ...
    std::cout << "JJJ emptyB: " << pipeline->getSources().empty() << std::endl;
    ...
    std::cout << "JJJ emptyC: " << pipeline->getSources().empty() << std::endl;

    std::cout << "JJJ !projForQuery.isEmpty(): " << static_cast<bool>(!projForQuery.isEmpty())
              << std::endl;
    std::cout << "JJJ !sources.empty(): " << static_cast<bool>(!sources.empty()) << std::endl;
    ...
    if (!projForQuery.isEmpty() && !sources.empty()) {
        ...
        std::cout << "JJJ proj: " << static_cast<bool>(proj)
                  << ", proj->isSubsetOfProjection(projForQuery): "
                  << proj->isSubsetOfProjection(projForQuery) << std::endl;
    ...
    std::cout << "JJJ emptyD: " << pipeline->getSources().empty() << std::endl;
...
StatusWith<std::unique_ptr<PlanExecutor, PlanExecutor::Deleter>> PipelineD::prepareExecutor(
    ...
    *projectionObj = removeSortKeyMetaProjection(*projectionObj);
    ...
    std::cout << "JJJ swExecutorProj: " << swExecutorProj.getStatus() << std::endl;
